...
const Projects = ({ projects }) => {
  ...
  return (
    <div className="flex flex-col px-6 mb-7" style={{marginTop: '-40px'}}>
...
const ProjectCard = ({ project }) => {
    // const originalTimestamp = Number(project?.expiresAt + '000');
    // const newTimestamp = originalTimestamp - 28800000;
    // const expired = new Date().getTime() > newTimestamp;
